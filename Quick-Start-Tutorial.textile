...
###Installation###
Blueprint should be put in your site's CSS directory. After you've done that, add these two lines to the <code><head></code> of your web pages. Remember to make sure the href path is correct:
