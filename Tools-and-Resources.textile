...
* "BlueCalc CSS Generator":http://bluecalc.groupion.com/ -- BlueCalc v0.8 is great, but if you have more than 24 columns you might need to fix grid.css line 46 by adding your extra div.span classes (seems to be a bug in BlueCalc v0.8)
