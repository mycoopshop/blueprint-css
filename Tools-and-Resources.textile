...
* "BlueCalc CSS Generator":http://bluecalc.groupion.com/ -- BlueCalc v0.8 is great, but if you have more than 24 columns you might need to fix grid.css by adding your extra div.span classes to line 46 (and other similar lines); seems to be a bug in BlueCalc v0.8.
